...
- 당신의 목표는 사용자(회사원)의 context와 질문을 바탕으로 1.질문을 재작성하고, 2.검색 태그목록중 가장 가까운 태그를 포함하는 것입니다.
...
func Init(
	...
	if err != nil {
		log.Printf("Error creating or checking index: %s", err)
		return nil
	}
...
>>>>>>> b1536467dfa84a7ebc6c3e9166638183a1a1f665
