...
import type { ReadRootGetData, ReadRootGetResponses, GetMeApiV1UserGetData, GetMeApiV1UserGetResponses, GetToolsApiV1ToolsGetData, GetToolsApiV1ToolsGetResponses, GetToolsApiV1ToolsGetErrors, GetToolByIdApiV1ToolsToolIdGetData, GetToolByIdApiV1ToolsToolIdGetResponses, GetToolByIdApiV1ToolsToolIdGetErrors, SubscribeToolApiV1ToolsToolIdSubscribePostData, SubscribeToolApiV1ToolsToolIdSubscribePostResponses, SubscribeToolApiV1ToolsToolIdSubscribePostErrors, NewConversationApiV1ConversationsNewPostData, NewConversationApiV1ConversationsNewPostResponses, GetConversationsApiV1ConversationsGetData, GetConversationsApiV1ConversationsGetResponses, GetConversationApiV1ConversationsConversationIdGetData, GetConversationApiV1ConversationsConversationIdGetResponses, GetConversationApiV1ConversationsConversationIdGetErrors, GenerateCompletionApiV1CompletionPostData, GenerateCompletionApiV1CompletionPostResponses, GenerateCompletionApiV1CompletionPostErrors, GetAvailableAgentsApiV1AgentsGetData, GetAvailableAgentsApiV1AgentsGetResponses, GetAvailableAgentsApiV1AgentsGetErrors, GetAgentApiV1AgentsAgentIdVersionAgentVersionGetData, GetAgentApiV1AgentsAgentIdVersionAgentVersionGetResponses, GetAgentApiV1AgentsAgentIdVersionAgentVersionGetErrors, SubscribeAgentApiV1AgentsAgentIdVersionAgentVersionSubscribePostData, SubscribeAgentApiV1AgentsAgentIdVersionAgentVersionSubscribePostResponses, SubscribeAgentApiV1AgentsAgentIdVersionAgentVersionSubscribePostErrors, PublishAgentApiV1AgentsPublishPostData, PublishAgentApiV1AgentsPublishPostResponses, PublishAgentApiV1AgentsPublishPostErrors, ModifyAgentApiV1AgentsAgentIdPutData, ModifyAgentApiV1AgentsAgentIdPutResponses, ModifyAgentApiV1AgentsAgentIdPutErrors, GetRecommendationsApiV1RecommendationsGetData, GetRecommendationsApiV1RecommendationsGetResponses, CreateRecommendationApiV1RecommendationsPostData, CreateRecommendationApiV1RecommendationsPostResponses, CreateRecommendationApiV1RecommendationsPostErrors, GetRecommendationByIdApiV1RecommendationsRecommendationIdGetData, GetRecommendationByIdApiV1RecommendationsRecommendationIdGetResponses, GetRecommendationByIdApiV1RecommendationsRecommendationIdGetErrors, ChatCompletionWithAgentApiV1RecommendationsAgentIdCompletionPostData, ChatCompletionWithAgentApiV1RecommendationsAgentIdCompletionPostResponses, ChatCompletionWithAgentApiV1RecommendationsAgentIdCompletionPostErrors, GetRecommendationConversationApiV1RecommendationsAgentIdConversationGetData, GetRecommendationConversationApiV1RecommendationsAgentIdConversationGetResponses, GetRecommendationConversationApiV1RecommendationsAgentIdConversationGetErrors } from './types.gen';
 ...
 */
export const subscribeToolApiV1ToolsToolIdSubscribePost = <ThrowOnError extends boolean = false>(options: Options<SubscribeToolApiV1ToolsToolIdSubscribePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SubscribeToolApiV1ToolsToolIdSubscribePostResponses, SubscribeToolApiV1ToolsToolIdSubscribePostErrors, ThrowOnError>({
 ...
 */
export const chatCompletionWithAgentApiV1RecommendationsAgentIdCompletionPost = <ThrowOnError extends boolean = false>(options: Options<ChatCompletionWithAgentApiV1RecommendationsAgentIdCompletionPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ChatCompletionWithAgentApiV1RecommendationsAgentIdCompletionPostResponses, ChatCompletionWithAgentApiV1RecommendationsAgentIdCompletionPostErrors, ThrowOnError>({
...
/**
 * Get Recommended Agent's Conversation
 ...
 */
export const getRecommendationConversationApiV1RecommendationsAgentIdConversationGet = <ThrowOnError extends boolean = false>(options: Options<GetRecommendationConversationApiV1RecommendationsAgentIdConversationGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetRecommendationConversationApiV1RecommendationsAgentIdConversationGetResponses, GetRecommendationConversationApiV1RecommendationsAgentIdConversationGetErrors, ThrowOnError>({
