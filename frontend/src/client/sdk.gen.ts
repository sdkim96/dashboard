 ...
 */
export const deleteFileApiV1FilesFileIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteFileApiV1FilesFileIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteFileApiV1FilesFileIdDeleteResponses, DeleteFileApiV1FilesFileIdDeleteErrors, ThrowOnError>({
